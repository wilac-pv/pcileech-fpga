...
HD_PWD='D:/code/pcileech-fpga/PCIeSquirrel/pcileech_squirrel/pcileech_squirrel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcileech_squirrel_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcileech_squirrel_top.tcl
