...
HD_PWD='D:/code/pcileech-fpga/PCIeSquirrel/pcileech_squirrel/pcileech_squirrel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pcileech_squirrel_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pcileech_squirrel_top.tcl -notrace
