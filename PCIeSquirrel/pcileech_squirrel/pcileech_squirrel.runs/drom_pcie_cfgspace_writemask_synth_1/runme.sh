...
HD_PWD='D:/code/pcileech-fpga/PCIeSquirrel/pcileech_squirrel/pcileech_squirrel.runs/drom_pcie_cfgspace_writemask_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drom_pcie_cfgspace_writemask.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drom_pcie_cfgspace_writemask.tcl
