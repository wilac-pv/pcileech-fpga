...
HD_PWD='D:/code/pcileech-fpga/PCIeSquirrel/pcileech_squirrel/pcileech_squirrel.runs/bram_pcie_cfgspace_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_pcie_cfgspace.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_pcie_cfgspace.tcl
