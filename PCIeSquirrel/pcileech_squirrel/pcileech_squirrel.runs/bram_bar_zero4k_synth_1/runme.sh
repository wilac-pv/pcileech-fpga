...
HD_PWD='D:/code/pcileech-fpga/PCIeSquirrel/pcileech_squirrel/pcileech_squirrel.runs/bram_bar_zero4k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_bar_zero4k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_bar_zero4k.tcl
